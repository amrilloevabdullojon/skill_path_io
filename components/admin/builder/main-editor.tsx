              ...
              {[...lesson.blocks].sort((a, b) => a.order - b.order).map((block, index) => (
                <article key={block.id} className="surface-subtle space-y-2 p-3">
                  <div className="flex flex-wrap items-center justify-between gap-1.5">
                    <p className="text-xs uppercase tracking-widest text-muted-foreground">Block {index + 1} - {block.type}</p>
              ...
              <div className="space-y-2">
                {quiz.questions.map((question, index) => (
                  <article key={question.id} className="surface-subtle space-y-2 p-3">
                    <div className="flex flex-wrap items-center justify-between gap-1.5">
                      <p className="text-xs uppercase tracking-widest text-muted-foreground">Question {index + 1}</p>
                      <div className="flex gap-1">
