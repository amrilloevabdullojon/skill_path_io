  ...
  return (
    <section className="surface-elevated space-y-4 p-5">
      <header className="space-y-2">
        <h1 className="text-2xl font-semibold text-foreground">Media Manager</h1>
        <p className="text-sm text-muted-foreground">Upload and manage covers, icons, files, and lesson attachments (local mock mode).</p>
      </header>
            ...
            <article key={asset.id} className="surface-subtle space-y-2 p-3">
              <div className="flex items-start justify-between gap-2">
                <div className="inline-flex items-center gap-2 text-sm text-muted-foreground">
                  <span className="rounded-lg border border-border bg-card p-1.5 text-muted-foreground">{iconByType(asset.type)}</span>
