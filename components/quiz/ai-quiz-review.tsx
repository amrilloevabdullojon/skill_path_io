  ...
  return (
    <section className="surface-subtle space-y-4 p-4 sm:p-5">
      <header className="space-y-1">
        ...
        <h3 className="text-lg font-semibold text-slate-100">Understand mistakes and fix gaps</h3>
        <p className="text-sm text-slate-400">AI explains why the answer is wrong and what to do next.</p>
      </header>
        ...
        {wrongAnswers.map((item, index) => {
          ...
          return (
            <article key={item.questionId} className="rounded-xl border border-rose-400/30 bg-rose-500/5 p-4">
              ...
              {review && (
                <div className="mt-3 space-y-2 rounded-xl border border-slate-700 bg-slate-900/70 p-3 text-sm text-slate-300">
