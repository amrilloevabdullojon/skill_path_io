...
export function LandingAmbientBackground() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      ...
      <motion.div
        className="absolute -left-32 top-[-220px] h-[520px] w-[520px] rounded-full bg-indigo-500/12 blur-3xl"
      ...
      />
      <motion.div
        className="absolute bottom-[-220px] left-1/3 h-[520px] w-[520px] rounded-full bg-indigo-500/10 blur-3xl"
