  ...
  return (
    <section className="surface-elevated space-y-4 p-5">
      <div className="flex items-center justify-between gap-2">
        <h2 className="text-lg font-semibold text-foreground">Skill Gap Detector</h2>
        <span className="chip-neutral inline-flex items-center gap-1 px-2.5 py-1 text-xs">
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <article className="surface-subtle space-y-2 p-3">
          <p className="text-xs uppercase tracking-[0.14em] text-muted-foreground">Covered skills</p>
        ...
        <article className="surface-subtle space-y-2 p-3">
          <p className="text-xs uppercase tracking-[0.14em] text-muted-foreground">Skill gaps</p>
          {gaps.length === 0 ? (
      ...
      <article className="surface-subtle space-y-2 p-3">
        <p className="text-xs uppercase tracking-[0.14em] text-muted-foreground">Recommended modules</p>
