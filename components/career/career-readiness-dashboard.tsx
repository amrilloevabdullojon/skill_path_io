    ...
    <section className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <article className="surface-elevated space-y-4 p-5">
          ...
          <p className="text-4xl font-semibold text-slate-100">{readiness.score}%</p>
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <div className="surface-subtle p-3">
              <p className="text-xs uppercase tracking-wide text-slate-500">Progress to target role</p>
              <p className="mt-1 text-lg font-semibold text-slate-100">{readiness.progressToGoal}%</p>
            </div>
            <div className="surface-subtle p-3">
              <p className="text-xs uppercase tracking-wide text-slate-500">Next milestone</p>
              <p className="mt-1 text-sm text-slate-200">{readiness.nextMilestone}</p>
            </div>
          </div>
        </article>

        <article className="surface-elevated space-y-4 p-5">
          <h2 className="text-lg font-semibold text-slate-100">Skill gap indicators</h2>
          ...
          <div className="surface-subtle p-3">
            <p className="text-xs uppercase tracking-wide text-slate-500">Recommended learning actions</p>
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_1fr]">
        ...
        <article className="surface-elevated space-y-3 p-5">
          ...
          <p className="text-sm text-slate-300">Move from theory to interview readiness by closing top 2 gaps this week.</p>
