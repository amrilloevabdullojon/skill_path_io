...
export function EntryExperience({ mode, enableDemoAccess = false, member }: EntryExperienceProps) {
  return (
    <section className="relative overflow-hidden rounded-[32px] p-4 sm:p-6 lg:p-10 border border-border/40 shadow-[0_8px_40px_rgba(0,0,0,0.06)] bg-card/40 backdrop-blur-3xl min-h-[500px] flex flex-col justify-center">
        ...
        {mode === "member" && member ? (
          <div className="grid items-stretch gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <MotionCard className="flex flex-col h-full">
              <article className="h-full flex flex-col justify-between surface-elevated border border-border/50 bg-card/40 backdrop-blur-md rounded-[28px] p-6 sm:p-8 relative overflow-hidden transition-all duration-300 hover:border-indigo-500/30 hover:shadow-[0_8px_30px_rgba(99,102,241,0.06)]">
                ...
                <div className="space-y-6 relative z-10">
                  ...
                  <div>
                    <h1 className="text-4xl lg:text-5xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-foreground to-foreground/70">
                  ...
                  <div className="grid gap-4 sm:grid-cols-3 pt-4">
                    <div className="surface-subtle p-4 rounded-2xl border border-border/40 hover:bg-background/60 transition-colors">
            ...
            <div className="space-y-6 flex flex-col h-full">
              <MotionCard delay={0.15} className="flex-1">
                <Link href="/missions" className="block h-full group">
                  <article className="h-full surface-elevated border border-border/50 bg-card/40 backdrop-blur-md rounded-[28px] p-6 hover:border-violet-500/30 hover:bg-violet-500/5 transition-all duration-300 relative overflow-hidden flex flex-col justify-center">
              ...
              <MotionCard delay={0.25} className="flex-1">
                <article className="h-full surface-elevated border border-border/50 bg-card/40 backdrop-blur-md rounded-[28px] p-6 relative overflow-hidden flex flex-col justify-center">
          ...
          <div className="grid items-stretch gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:gap-8">
            <div className="space-y-6 flex flex-col justify-center">
              <MotionCard>
                <article className="surface-elevated border border-border/50 bg-card/40 backdrop-blur-md rounded-[28px] space-y-6 p-6 sm:p-8 relative overflow-hidden">
                  ...
                  <h1 className="text-4xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-foreground to-foreground/70 sm:text-5xl leading-[1.1] relative z-10">
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                <MotionCard delay={0.1}>
                  <article className="surface-subtle border border-border/40 bg-card/30 backdrop-blur-sm p-5 rounded-[20px] transition-all hover:bg-card/60">
            ...
            <MotionCard delay={0.25} className="flex flex-col justify-center h-full">
              <div className="space-y-4 surface-elevated border border-border/50 bg-card/40 backdrop-blur-md rounded-[28px] p-6 sm:p-8 h-full flex flex-col relative overflow-hidden">
                ...
                <div className="flex items-center justify-between p-3 surface-subtle border border-border/40 rounded-xl mb-4 relative z-10">
                  {enableDemoAccess ? (
                    <>
