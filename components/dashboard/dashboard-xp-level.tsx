  ...
  return (
    ...
    >
      <div className="grid min-w-0 gap-4 2xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
        <div className="min-w-0 space-y-4 rounded-2xl border border-slate-800 bg-slate-950/75 p-4">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="min-w-0">
              <p className="kicker">Level progress</p>
              <p className="mt-1 text-3xl font-semibold tracking-tight text-slate-100">{xp.totalXp} XP</p>
            </div>
          ...
          <div className="grid grid-cols-1 gap-2 text-center text-xs sm:grid-cols-3">
            <div className="rounded-xl border border-slate-800 bg-slate-900/75 p-2.5">
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-900/75 p-2.5">
              ...
              <p className="mt-1 text-sm font-semibold text-slate-100">{xp.badgesCount}</p>
            </div>
            <div className="rounded-xl border border-slate-800 bg-slate-900/75 p-2.5">
          ...
          <div className="flex flex-wrap gap-1.5">
            {xp.badges.length === 0 ? (
              <span className="rounded-full border border-slate-800 bg-slate-900/70 px-2.5 py-1 text-xs text-slate-500">
        ...
        <div className="min-w-0 rounded-2xl border border-slate-800 bg-slate-950/70 p-4">
          <p className="text-sm font-semibold text-slate-100">Weekly completion trend</p>
          <p className="mt-1 text-xs text-slate-500">Last 8 weeks of progress and finished modules</p>
